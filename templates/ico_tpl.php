        ...
        <div class="">
            <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
                <div class="div-item-ico">
                    <span>Total UCH Token</span><b class="total-coin-b moneyFormat">6,000,000</b>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 col-sm-5 col-xs-12">
                <div class="div-item-ico">
                    <span>Sold UCH Token</span><b class="sold-coin-b moneyFormat">3,500,000</b>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8 col-sm-12 col-xs-12">
            <div class="div-ico-list">
                <div class="div-ico-header">
                    ...
                    <span style="float:right;font-weight: normal;">ICO time: November 15 2017, 10 am - NewYork time (GMT - 5)</span>
                </div>
                    ...
                    <table class="table">
                        ...
                        <tbody data-bind="foreach:ICOList">
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-11-15</span>
                                </td>
                                <td>
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-11-18</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">150,000 </span>
                                </td>
                                <td>
                                    <span data-bind="text: Price">0.82</span>
                                </td>
                                <td>
                                    <!-- ko if: Status ==1 --><!-- /ko -->
                                    <!-- ko if: Status ==2 --><!-- /ko -->
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-11-20</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">750,000 </span>
                                </td>
                                <td>
                                    <span data-bind="text: Price">0.88</span>
                                </td>
                                <td>
                                    <!-- ko if: Status ==1 --><!-- /ko -->
                                    <!-- ko if: Status ==2 --><!-- /ko -->
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-11-22</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">500,000 </span>
                                </td>
                                <td>
                                    <span data-bind="text: Price">0.91</span>
                                </td>
                                <td>
                                    <!-- ko if: Status ==1 --><!-- /ko -->
                                    <!-- ko if: Status ==2 --><!-- /ko -->
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-11-24</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">500,000 </span>
                                </td>
                                <td>
                                    <span data-bind="text: Price">0.94</span>
                                </td>
                                <td>
                                    <!-- ko if: Status ==1 --><!-- /ko -->
                                    <!-- ko if: Status ==2 --><!-- /ko -->
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-11-26</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">500,000 </span>
                                </td>
                                <td>
                                    <span data-bind="text: Price">0.97</span>
                                </td>
                                <td>
                                    <!-- ko if: Status ==1 --><!-- /ko -->
                                    <!-- ko if: Status ==2 --><!-- /ko -->
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-11-28</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">500,000 </span>
                                </td>
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-11-30</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">500,000 </span>
                                </td>
                                <td>
                                    <span data-bind="text: Price">1.03</span>
                                </td>
                                <td>
                                    <!-- ko if: Status ==1 --><!-- /ko -->
                                    <!-- ko if: Status ==2 --><!-- /ko -->
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-12-02</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">500,000 </span>
                                </td>
                                <td>
                                    <span data-bind="text: Price">1.06</span>
                                </td>
                                <td>
                                    <!-- ko if: Status ==1 -->
                                    <div>
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-12-04</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">500,000 </span>
                                </td>
                                <td>
                                    <span data-bind="text: Price">1.09</span>
                                </td>
                                <td>
                                    <!-- ko if: Status ==1 -->
                                    <div>
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-12-06</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">500,000 </span>
                                </td>
                                <td>
                                    <span data-bind="text: Price">1.12</span>
                                </td>
                                <td>
                                    <!-- ko if: Status ==1 -->
                                    <div>
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-12-08</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">500,000 </span>
                                </td>
                                <td>
                                    <span data-bind="text: Price">1.15</span>
                                </td>
                                <td>
                                    <!-- ko if: Status ==1 -->
                                    <div>
                            ...
                            <tr data-bind="css: trenabled" class="enabled">
                                <td>
                                    <span data-bind="text: TxtTime">2017-12-10</span>
                                </td>
                                <td>
                                    <span class="total-coin-ico" data-bind="text: Coin">500,000 </span>
                                </td>
                                <td>
                                    <span data-bind="text: Price">1.20</span>
                                </td>
                                <td>
                                    <!-- ko if: Status ==1 -->
                                    <div>
                ...
                <div class="div-ico-footer text-left">
                    <b>Reminder:</b> There will be a limit to the amount of UCH that each individual is allowed to buy, and limiting the amount of UCH purchased will be informed each ICO time. Therefore you should check your email constantly to update the ICO time so that you wouldn’t lose the chance to acquire the amount of coin that you desire.
                </div>
            </div>
        </div>
    </div>
