...
<div class="div-ico-controller" id="div-ico-controller">
    <div class="row div-user-coin">
        ...
        <div class="col-sm-4 col-xs-12">
            <div class="div-user-coin-item">
                <img src="images/uch.png"><span>UCH</span><b class="uch--value--color">0.00000000</b>
            </div>
        </div>
        <div class="col-sm-4 col-xs-12">
            <div class="div-user-coin-item">
    ...
    <div class="div-price text-center">
        <b>Price: 1.06</b><b> USD</b>
    </div>
    <div class="div-process">
        <div class="div-process-left">
            <div class="progress">
                <div id="process--ico" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 5%">5%</div>
            </div>
        </div>
        <div class="div-process-right">
            <span class="moneyFormat">500000</span><span> UCH</span>
        </div>
    ...
    <div class="ico-transaction-container">
        <div class="ico-transaction-header">
            ...
            <div class="pull-right">
                <select class="form-control" id="select-transaction">
                    <option value="0">All transaction</option>
                    <option value="1">My transaction</option>
                </select>
            </div>
        </div>
